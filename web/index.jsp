            ...
            <header id="header" class="header-scroll top-header headrom">
                ...
                <nav class="navbar navbar-dark">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="index.html"> <img class="img-rounded logo-img" src="images/logo.png" alt=""> </a>
                        <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item"> <a class="nav-link active" href="contact.html">Contact Us <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link active" href="index.html">Support <span class="sr-only">(current)</span></a> </li>
                                <li class="nav-item"> <a class="nav-link active" href="cart.jsp">Cart <%=selecteditems.size()%><span class="sr-only">(current)</span></a> </li>

                                <% if (user == null) { %>                            
                                <li class="nav-item"> <a class="nav-link active" href="registration.jsp"> <img width="23px;" src="images/user.png">
                                        Login or Sign Up <span class="sr-only">(current)</span></a> </li>
                                        <% } else {%>
                                <li class="nav-item"> <a class="nav-link active" href=""> <img width="23px;" src="images/user.png">
                                        <%=user.getFullname()%> <span class="sr-only">(current)</span></a> </li>
            ...
            <section class="hero bg-image" data-image-src="images/image01.jpg">
                <div class="hero-inner">
                    <div class="container text-center hero-text font-white">
                        ...
                        <h5 class="font-white space-xs">Find specials, and coupons for free</h5>
                        <div class="banner-form">
                            <form class="form-inline">
                                ...
                                <button onclick="location.href = 'food_results.html'" type="button" class="btn theme-btn btn-lg">Search food</button>
                            </form>
                        </div>
                        <div class="steps">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                <div class="figure-wrap bg-image" data-image-src="images/food1.jpg">
                                    <div class="distance"><div class="mins"><i class="fa fa-motorcycle"></i> 30 min</div></div>
                                    <!-- <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div> -->
                                    <!-- <div class="review pull-right"><a href="#">198 reviews</a> </div> -->
                                </div>
                                <div class="content">
                                    <h5><a href="profile.html"><%=item.getItemnm()%></a></h5>
                                    <div class="product-name"><%=item.getCat().getCatnm()%></div>
                                    <div class="price-btn-block"> <span class="price">Rs. <%=item.getItemprice()%></span> 
                                        <form action="index.jsp">
                                            <!--
                                        <a href="#" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                            -->
                                            <input type="hidden" name="itemid" value="<%=item.getItemid()%>"/>
                                            <input type="submit" name="btn" class="btn theme-btn-dash pull-right" value="Order Now" /> 
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row top-footer">
                        <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                            <a href="#"> <img src="images/logo.png" width="200px" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
